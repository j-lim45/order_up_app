...
class AuthService {
  // instance to sign in, log in, reset
  ...
  Future<void> resetPasswordFromCurrentPassword({required currentPassword, required String newPassword, required String email}) async {
